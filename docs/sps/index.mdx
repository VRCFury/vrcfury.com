...
* In that VRC Fury component, click the "+" on the bottom right and add an `SPS Options` subcomponent.
* In the `Menu Path` box, type where you'd like it to be in your menu. The default is `SPS`.
* Done!
