...
SPS, or Super Plug Shader, is a free deformation shader that can used to deform meshes towards a target. This is a
fully-compatible replacement for DPS (Dynamic Penetration System) by Raliv, and TPS (Thry Penetration System) included
in Poiyomi.
...
* Check "Enable TPS" on the VRCFury Haptic Plug component in the Inspector on the right
...
* Ensure the light bulb on the top left of the 3d view is ON
* Go into play mode, and move things around to test!
