...
* You may have accidentally updated the VRChat Package Resolver Tool in the VCC to 0.1.27 or newer.
* These versions are only for unity 2022. If you are unity 2019, use 0.1.26.
