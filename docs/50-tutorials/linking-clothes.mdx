...
:::warning
Blendshapes driven by VRChat directly like Visemes, Blinking or Look Up/Down are special and cannot be linked by Blendshape Link as they are not driven through animations.
:::