...
* *The plug mesh must be straight / "fully extended" in the editor!!*
  ...
  * If you wish for the plug to not be extended in the avatar's resting state, you can use an animation in the plug component's "Post-Bake Actions" box to un-extend it.
