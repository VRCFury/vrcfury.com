...
Note: All of these limitations only apply while deformation is enabled. If SPS plug deformation is disabled by animating off the "Animated Toggle" box on the SPS plug, then you can go nuts and do whatever you want.
