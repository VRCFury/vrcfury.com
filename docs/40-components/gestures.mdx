...
:::warning
Due to a Unity bug, reordering Gestures may [cause the Unity Editor to crash](https://github.com/VRCFury/VRCFury/issues/229). Avoid reordering gestures and save your scene regularly.
:::
