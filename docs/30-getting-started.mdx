...
1. If you're installing a VRCFury-ready prefab from an artist, stop here! Since their prefab is already setup for VRCFury, you don't need to set up your own components! Simply drag the VRCFury-ready prefab on your avatar and follow instructions if any apply.\
 Tip: If the asset you're trying to add to your avatar does not come with VRCFury already setup, take a look at the [Prefab sharing channel](https://discord.com/channels/1001423276553285653/1142607374096552040) on the [VRCFury Discord](https://vrcfury.com/discord), someone might already have made a VRCFury-ready community prefab for your asset!
